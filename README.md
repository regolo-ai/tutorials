...
| **[SearXNG Private Research Scraper](searxng-scraper/)** | Private web research agent fleet with SearXNG search backend, 6-worker subagent query expansion, spatial chunking, and Regolo.ai grounded synthesis. | `Python` · `Runnable` · `GPU 100% Ready` | [Read Article](article.md) |
